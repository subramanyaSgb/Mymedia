...
// Visible categories: video only. Songs/books/games were removed from the UI;
// their entries stay in the Record maps below because the DB schema still allows
// old rows with those categories.
