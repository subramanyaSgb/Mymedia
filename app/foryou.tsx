...
import { EmptyState, Icon, Screen, SectionHeader, Text, useColors, useThemedStyles } from '@/components/ui';
    ...
    <Pressable
      ...
      {entry.imageUrl ? (
        ...
        <View style={[styles.thumb, styles.thumbFallback]}>
          <Icon name="film" size={18} color={c.textFaint} />
        </View>
      )}
      <View style={{ flex: 1 }}>
...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  thumbFallback: { backgroundColor: c.surfaceHi, alignItems: 'center', justifyContent: 'center' },
});
