...
import { Chip, haptic, Icon, Poster, Screen, SectionHeader, Text, EmptyState, useColors, useThemedStyles } from '@/components/ui';
    ...
    <Pressable
      ...
      <View>
        ...
        <View style={[styles.badge, added && styles.badgeAdded]}>
          <Icon name={added ? 'checkmark' : 'add'} size={14} color={c.onAccent} />
        </View>
        {logos.length > 0 ? (
...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  badgeAdded: { backgroundColor: c.success },
  providerRow: {
    position: 'absolute',
    bottom: 6,
    left: 6,
