...
import { Button, Chip, haptic, Icon, SectionHeader, Text, useColors, useThemedStyles } from '@/components/ui';
  ...
  if (!item) {
    ...
    return (
      <View style={styles.center}>
        ...
        {loaded ? (
          <>
            <Icon name="alert-circle-outline" size={32} color={c.textFaint} />
      ...
      <View style={[styles.hero, { height: heroH }]}>
        {item.imageUrl ? (
          ...
          <View style={styles.heroFallback}>
            <Icon name={CATEGORY_ICON[item.category]} size={64} color={c.textFaint} />
          </View>
        )}
        <LinearGradient
          colors={['rgba(0,0,0,0.35)', 'transparent', 'rgba(0,0,0,0.55)', c.bg]}
          locations={[0, 0.35, 0.75, 1]}
          style={StyleSheet.absoluteFill}
        />
        <View style={styles.heroText}>
          <Text variant="kicker" color={c.textMuted}>
          ...
          <View style={styles.metaRow}>
            ...
            <Pressable
              ...
              <Icon
                ...
                size={20}
                color={item.favorite ? c.danger : c.textMuted}
              />
            </Pressable>
          </View>
        </View>
          ...
          {statuses(item.category).map((s, i) => {
            ...
            return (
              <Pressable
                ...
                />
                <Text variant="micro" color={active ? c.onAccent : c.textMuted}>
          ...
          {[1, 2, 3, 4, 5].map((n) => (
            <Pressable
              ...
              <Icon
                ...
                size={26}
                color={(item.userRating ?? 0) >= n ? c.accent : c.textFaint}
              />
            </Pressable>
          ))}
        </View>
...
function Stepper({ label, value, onDec, onInc }: { label: string; value: number; onDec: () => void; onInc: () => void }) {
  ...
  return (
    <View style={styles.stepper}>
      <Text variant="micro" color={c.textFaint}>
        {label.toUpperCase()}
      </Text>
...
function WhereToWatchSection({ kind, sourceId }: { kind: 'movie' | 'series'; sourceId: string }) {
  ...
  return (
    <View style={styles.section}>
          ...
          <Pressable
            ...
            {p.logo ? (
              ...
              <View style={[styles.providerLogo, styles.providerLogoFallback]}>
                <Icon name="tv-outline" size={20} color={c.textFaint} />
              </View>
            )}
      ...
      <Text variant="micro" color={c.textFaint} style={styles.providerHint}>
          ...
          <Pressable
            ...
            {member.profileImage ? (
              ...
              <View style={[styles.castImage, styles.castImageFallback]}>
                <Icon name="person" size={28} color={c.textFaint} />
              </View>
            )}
        ...
        <Pressable
          ...
          {member.profileImage ? (
            ...
            <View style={[styles.crewImage, styles.crewImageFallback]}>
              <Icon name="person" size={20} color={c.textFaint} />
            </View>
          )}
            ...
            <Pressable
              ...
              {e.poster ? (
                ...
                <View style={[styles.seriesImage, styles.seriesImageFallback]}>
                  <Icon name={CATEGORY_ICON[category]} size={24} color={c.textFaint} />
                </View>
              )}
              <View style={[styles.railAddBtn, added && styles.railAddBtnDone]}>
                <Icon name={added ? 'checkmark' : 'add'} size={16} color={c.onAccent} />
              </View>
...
const makeStyles = (c: Palette) =>
  ...
  segmentDivider: { borderLeftWidth: StyleSheet.hairlineWidth, borderLeftColor: c.border },
  ...
  providerLogoFallback: { backgroundColor: c.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  castImageFallback: { backgroundColor: c.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  crewImageFallback: { backgroundColor: c.surface, alignItems: 'center', justifyContent: 'center' },

  seriesCard: { width: 110, gap: space.xs },
  seriesImage: { width: 110, height: 156, borderRadius: radius.md },
  seriesImageFallback: { backgroundColor: c.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  railAddBtnDone: { backgroundColor: c.success },
});
