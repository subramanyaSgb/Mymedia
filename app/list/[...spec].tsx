...
import { Chip, EmptyState, haptic, Icon, Text, useColors, useThemedStyles } from '@/components/ui';
...
function ActionBtn({
  ...
  return (
    <Pressable
      ...
      <Icon name={icon} size={22} color={danger ? c.danger : c.text} />
      <Text variant="micro" color={danger ? c.danger : c.textMuted}>
        {label.toUpperCase()}
      </Text>
    </Pressable>
  );
...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  search: { flex: 1, color: c.text, fontSize: 14, paddingVertical: 9 },
